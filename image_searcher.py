...
def scroll_down(driver, scroll_pause_time=4, scroll_limit=400):
...
def scrape_and_save_images(base_folder, num_images=100):
    ...
    search_term = (found_brand_in_text.formatted_output)
...
if __name__ == "__main__":
    base_folder = r"C:\Users\Lenovo\Desktop\connect two file python"
    
    scrape_and_save_images(base_folder, num_images=2000)